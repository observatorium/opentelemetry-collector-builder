...
exporters:
  - gomod: "github.com/open-telemetry/opentelemetry-collector-contrib/exporter/alibabacloudlogserviceexporter v0.16.0"
EOF
...
dist:
    ...
    otelcol_version: "0.16.0" # the OpenTelemetry Collector version to use as base for the distribution. Optional.
...
exporters:
  - gomod: "github.com/open-telemetry/opentelemetry-collector-contrib/exporter/alibabacloudlogserviceexporter v0.16.0" # the Go module for the component. Required.
